...
final theme = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    secondary: Colors.amber[600], // A warm amber for interactive elements
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(20),
      borderSide:
          BorderSide(color: Colors.amber[600]!), // Focus border color
    ),
    hintStyle: TextStyle(
...
void main() {
  ...
  SystemChrome.setPreferredOrientations([
    ...
    runApp(const ProviderScope(child: Cooka()));
  });
}

class Cooka extends StatelessWidget {
  const Cooka({super.key});
